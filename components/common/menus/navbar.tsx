	...
	const menuItems =
		...
		subLinks.map((item) => (
			<MenuItem
				...
				component={Link}
				href={item.link}
				leftSection={item.leftSection && <item.leftSection size={iconSize} stroke={iconStrokeWidth} />}
				rightSection={item.rightSection && <item.rightSection size={iconSize} stroke={iconStrokeWidth} />}
